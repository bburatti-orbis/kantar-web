...
<script type="text/javascript" src="../../js/mod_tareas.js" ></script>
...
<jsp:include page="menu.jsp" flush="true"/>
  	...
  	<div class="caja_titulo">Modificar tarea</div>
 ...
 <div class="control_fila2">
    ...
    <div class="tit_control"><p>Tarea Predecesora</p></div>	
                ...
                <div class="control">
					...
					<input id="predecesoras"  class=" boton2"name="enviar" type="button" value="Agregar">
					 </div>
...
<div id="divpredecesora" class="caja">


</div>
<div id="divboton" class="caja">
