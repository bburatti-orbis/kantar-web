...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/ui/1.12.0-beta.1/themes/smoothness/jquery-ui.css" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<script src="${pageContext.request.contextPath}/js/jquery-1.12.1.min.js"></script>
<script src="${pageContext.request.contextPath}/js/ui/1.12.0-beta.1/jquery-ui.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/estado.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/JSBUSCAR.js"></script>
...
<body>
	<div id="wrap">
		<header>
			<div class="logo">
				<a href="index.cl"><img src="${pageContext.request.contextPath}/img/logo-kantar.png" width="191"
		...
		<div class="contenedor_general">
			...
			<div class="caja_final">
				<div class="inferior_home">
					...
					<div class="excel">
						<a href="#"><img src="${pageContext.request.contextPath}/img/excel-icon.png" width="26"
