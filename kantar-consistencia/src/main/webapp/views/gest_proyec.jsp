...
<div class="control">
            	<div class="tit_control"><p>Proyecto:</p> </div>
            	 <div class="llama_base"><p id="nombre"></p></div>

   	  		</div>
   	  		<div class="control">
            	<div class="tit_control"><p>Id Proyecto:</p> </div>
            	 <div class="llama_base"><p id="id"></p></div>

   	  		</div>
            
            <div class="control">
            	<input id="tareas"  class=" boton_gestion"name="enviar" type="button" value="Agregar Tarea">
        	</div>
        ...
        <div class="caja_titulo"><p>Lista de tareas Por Proyecto</p></div>
...
<div class="caja">
    ...
    <div class="tit_control"><p>Editar</p></div>	
            		</div>
 ...
 <div class="control_fila2">
        	...
        	<div class="control">
      <input id="editartarea"  class=" boton_gestion"name="enviar" type="button" value="Guardar Tarea"></div></div>
